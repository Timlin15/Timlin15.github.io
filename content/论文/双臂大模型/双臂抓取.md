...
同时[MARL](强化学习基本概念.md)为双臂机器人提供了强大的训练框架，使得多臂训练不再是训练多个机械臂的共享参数，而是针对每个机械臂的参数进行训练。
## 论文方法
论文为双臂抓物技巧训练提出了Heterogeneous(异质的)-Agent Reinforcement Learning方法并采用[HAPPO](强化学习基本概念.md)作为优化目标。
论文的主要成果是：
- 训练双臂抓取技巧
- 对抗-合作训练方式
- 用多物体验证
